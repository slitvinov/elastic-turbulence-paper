...
\documentclass[aps,pre,twocolumn,showpacs,superscriptaddress,groupedaddress]{revtex4}  % for review and submission
%\documentclass[aps,preprint,showpacs,superscriptaddress,groupedaddress]{revtex4}  % for double-spaced preprint
\usepackage{graphicx,color}  % needed for figures
\usepackage{dcolumn}  
\usepackage{amssymb}   % for math % needed for some tables
